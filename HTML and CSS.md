...
* `contain-intrinsic-size` - задает браузеру примерный размер элемента, пока его содержимое не отрисовано полностью. (шорткат для `contain-intrinsic-width`, `contain-intrinsic-height`) <font color="#7ead74">_**[Baseline 2026]**_</font>  
