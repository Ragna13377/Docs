...
_Псевдоклассы срабатывают в момент ввода или при первоначальной загрузке при отсутствии заполнения в полях `required`
...
Функциии: `calc(), min(), max(), clamp()` - используются в математических рассчетах    
Примеры:  
